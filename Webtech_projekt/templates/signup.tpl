...
<body class="bg-secondary">
    <div style="height: 75%" class="container bg-light w-50 shadow">
        ...
        <div class="row mb-3 mt-0 justify-content-center align-items-center">
            <div class="col-5 text-center">
                <form action="/sign_up" method="post" id="signup_form">
                    <input name="username" placeholder="Username" class="w-100 mb-2"><br>
                    <input name="pass1" type="password" placeholder="Password" class="w-100 my-2" id="password"><br>
                    <input name="pass2" type="password" placeholder="Password again" class="w-100 my-2", id="password2">
        ...
        <div class="row my-3 justify-content-center align-items-center">
            <div class="col-5 text-center">
                <button type="submit" form="signup_form" style="width: 100%;" class="btn btn-outline-primary">Signup</button>
            </div>
        </div>
    </div>
</body>
